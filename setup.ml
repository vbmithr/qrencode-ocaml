...
(* OASIS_START *)
(* DO NOT EDIT (digest: f582471b70d5e9efd108e81c967d6041) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Warnegia"];
          homepage = None;
          synopsis = "Binding to libqrencode";
          description =
            Some "More info at https://code.google.com/p/qrencode-ocaml/";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["qrencode_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lpng"; "-lqrencode"])];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "qrencode"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\186\017\154-\153d\177\1309\018ZF\190\025\020\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
